...
public class CountryCodePickerViewController: UITableViewController {
    ...
    lazy var cancelButton: UIBarButtonItem =  {
        ...
        buttonItem.image = #imageLiteral(resourceName: "cross")
        buttonItem.tintColor = UIColor.blue
        buttonItem.target = self
        buttonItem.action = #selector(dismissAnimated)
        /*if #available(iOS 13.0, *) {
            buttonItem = UIBarButtonItem(barButtonSystemItem: .close, target: self, action: #selector(dismissAnimated))
        } else {
            buttonItem = UIBarButtonItem(barButtonSystemItem: .cancel, target: self, action: #selector(dismissAnimated))
        }*/
        return buttonItem
    }()
    ...
    public override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.font = UIFont.systemFont(ofSize: 16, weight: .medium)//.preferredFont(forTextStyle: .callout)
        cell.detailTextLabel?.font = UIFont.systemFont(ofSize: 16, weight: .medium)//.preferredFont(forTextStyle: .body)
